...
public class Way2Sms {
   // private URLConnection sendSMSConnection;
    ...
    public void sendSMS(String phoneNumber,String message,String action,String username,String password)
    {
            ...
            try {
              ...
              //  sendContent="custid=undefined&HiddenAction=instantsms&Action=sa65sdf656fdfd&login=&pass=&MobNo=9543246247&textArea=hello";
                ...
                {
                    SendResult.append(line=bufferedReader.readLine());
                    SendResult.append('\n');
              ...
              //retrying
                if(a==6)a=0;
                a++;
                baseurl="http://site24.way2sms.com/";
                System.out.println(baseurl);
                loginWay2SMS(username,password);
    ...
    {  
        final String USERNAME="7095019947";//REQUIRED
        final String PASSWORD="7095019947san";//REQUIRED
        final String ACTION="action?Token=060DF1FE58CDC9B104088567A3DAB5AA.w801";//REQUIRED :e.g sa65sdf656fdfd  In order to understand ACTION value please read the blog
     ...
     /*   if(args.length>0)
        ...
        { */
        	String msg2=" demo hi "; //msg to be sent
            phoneNumber.append("7095019947"); /*want to use as bean ??? pass the parametrs for phone,message to send multiple number just insert ';' between them and pass as  a string */
            phoneNumber.append(';');
